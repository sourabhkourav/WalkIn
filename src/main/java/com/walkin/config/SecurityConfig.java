    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/public/hiring-drives/**").permitAll()
                        .requestMatchers(
                                HttpMethod.POST,
                        ...
                        .hasAnyRole("PLATFORM_ADMIN", "COMPANY_ADMIN", "RECRUITER")
                        .requestMatchers("/actuator/prometheus").hasRole("PLATFORM_ADMIN")
                        .requestMatchers("/api/users/**").hasRole("PLATFORM_ADMIN")
                        ...
                        .hasAnyRole("PLATFORM_ADMIN", "COMPANY_ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/hiring-drives/**", "/api/company-rounds/**")
                        .hasAnyRole("PLATFORM_ADMIN", "COMPANY_ADMIN", "RECRUITER")
                        .requestMatchers("/api/hiring-drives/**", "/api/company-rounds/**")
                        .hasAnyRole("PLATFORM_ADMIN", "COMPANY_ADMIN")
                        .requestMatchers("/api/hiring-drive-setups/**")
                        .hasAnyRole("PLATFORM_ADMIN", "COMPANY_ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/interview-rounds/**")
                        .hasAnyRole("PLATFORM_ADMIN", "COMPANY_ADMIN", "RECRUITER")
                        .requestMatchers("/api/interview-rounds/**")
                        .hasRole("PLATFORM_ADMIN")
                        .requestMatchers("/api/**").hasRole("PLATFORM_ADMIN")
